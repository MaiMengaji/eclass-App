        ...
        actions: <Widget>[
          FlatButton(
              ...
              child: Text(
                ...
                style: TextStyle(
                    color: Color(0xFFFF8400), fontWeight: FontWeight.w600),
              )),
          SizedBox(height: 16),
          FlatButton(
              onPressed: () {
  ...
  Widget navigationBar() {
    return Container(
      ...
      child: BottomNavigationBar(
        ...
        unselectedIconTheme: IconThemeData(color: const Color(0xFF525252)),
        selectedItemColor: const Color(0xFF000001),
